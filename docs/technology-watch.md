...
- IA locale : [Transformers.js](https://huggingface.co/docs/transformers.js/), [modèle Gemma 3 1B ONNX retenu](https://huggingface.co/onnx-community/gemma-3-1b-it-ONNX) et [WebGPU](https://www.w3.org/TR/webgpu/).
